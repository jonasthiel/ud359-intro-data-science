...
def lineplot_compare(hr_by_team_year_sf_la_csv):
    ...
    gg = ggplot(df, aes(x='yearID', y='HR', color='teamID')) + geom_point() + geom_line() + ggtitle('Homeruns hit by SF Giants and LA Dodgers') + xlab('Years') + ylab('Number of homerun hits')
